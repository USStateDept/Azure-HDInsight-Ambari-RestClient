    ...
    public class ApiClient
    {
            ...
            Dictionary<String, FileParameter> fileParams, String[] authSettings)
        {
            ...
            if (postBody != null) // http body (model) parameter
                request.AddParameter("text/plain",  postBody, "charset=utf-8", ParameterType.RequestBody);
        ...
        public object Deserialize(string content, Type type, IList<Parameter> headers=null)
        {
            ...
            catch (Newtonsoft.Json.JsonSerializationException ex)
            {
                ...
                var json = jToken.Children().Last<JToken>().Children().Last<JToken>().ToString();
                var obj = JsonConvert.DeserializeObject(json, type, new Newtonsoft.Json.JsonSerializerSettings());
                return obj;
            }
            catch (IOException e)
            {
