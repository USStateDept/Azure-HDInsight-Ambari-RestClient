...
namespace IO.Swagger.Model {
  ...
  public class GroupPrivilegeResponse {
    ...
    /// <summary>
    /// Gets or Sets PrivilegeInfogroupName
    /// </summary>
    [DataMember(Name="PrivilegeInfo/group_name", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "PrivilegeInfo/group_name")]
    public string PrivilegeInfogroupName { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  PrivilegeInfogroupName: ").Append(PrivilegeInfogroupName).Append("\n");
      sb.Append("}\n");
      return sb.ToString();
    }
